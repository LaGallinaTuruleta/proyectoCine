...
public class InterfasPruebaXDLol extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					InterfasPruebaXDLol frame = new InterfasPruebaXDLol(peliculas,sesiones,salas);
	...
	public InterfasPruebaXDLol(ArrayList<Pelicula> peliculas, ArrayList<Sesion> sesiones, ArrayList<Sala> salas) {
		setTitle("CineMAx");
		...
		BackgroundImage bi1 = new BackgroundImage();
		setTitle("CineMAx");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 590, 419);
		contentPane = new JPanel();
